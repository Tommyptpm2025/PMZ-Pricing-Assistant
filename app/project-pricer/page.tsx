...
export default function ProjectPricerPage() {
  ...
  return (
    <div className="max-w-6xl space-y-8 pb-12">
                        ...
                        <div className="text-right font-medium tabular-nums">
                          <div className="flex items-center justify-end gap-0.5">
                            ...
                            <input
                              ...
                              className="h-11 w-full min-w-0 text-right text-base tabular-nums font-mono border-0 bg-transparent focus-visible:bg-white focus-visible:border focus-visible:border-border px-1"
                              placeholder="0.00"
                              disabled={isReadOnly}
                            />
                          </div>
      ...
      {/* Update Export Modal — shared presentational dialog (also used by the Quotes-page preview) */}
      <UpdateExportDialog
