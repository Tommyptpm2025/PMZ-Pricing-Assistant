        ...
        <div className="rounded-xl border bg-surface-2 p-5">
          ...
          <div
            className={cn(
              ...
              summary.overheadRemaining > 0 ? "bg-background" : "border-primary/40 bg-primary/5"
            )}
          >
            <div className="text-xs font-semibold tracking-wider text-muted-foreground">OVERHEAD RECOVERY COUNTDOWN</div>
            {summary.overheadRemaining > 0 ? (
              <div className="mt-1">
                <span className="text-2xl font-bold tabular-nums">{formatMoney(summary.overheadRemaining)}</span>
